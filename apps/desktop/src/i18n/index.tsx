...
const english: Record<string, string> = {
  ...
  "О программе и диагностика": "About and diagnostics",
  "Версия приложения": "Application version",
  "Подготовка локальной базы…": "Preparing the local database…",
  "Не удалось запустить Quanti": "Quanti could not start",
  "Повторить запуск": "Retry startup",
  "Восстановить последнюю копию": "Restore latest backup",
  "Выбрать резервную копию": "Choose a backup",
  "Сохранить журнал": "Save log",
  "Перенос данных в локальную Quanti": "Move data to local Quanti",
  "Выберите полный quanti-transfer v1 пакет из прежней PostgreSQL-версии. Quanti сначала покажет предпросмотр и импортирует данные одной транзакцией.": "Choose the full quanti-transfer v1 package exported from the previous PostgreSQL version. Quanti will show a preview first and import the data in one transaction.",
  "Начать с пустой базы": "Start with an empty database",
  "Проверить обновления": "Check for updates",
  "Установить {version}": "Install {version}",
  ...
  "Сохранить журнал диагностики": "Save diagnostic log",
  "Резервная копия создана:": "Backup created:",
  "Резервное копирование доступно в desktop-версии.": "Backup is available in the desktop version.",
  "Русский": "Russian",
  "Английский": "English",
  ...
  "Светлая": "Light",
  "Тёмная": "Dark",
  "Тема применяется сразу и сохраняется для следующих запусков.": "The theme is applied immediately and saved for future launches.",
  "Операции": "Operations",
  "Финансы": "Finance",
  "Создать": "Create",
  "Сохранить": "Save",
  ...
  "Импортировать список закупки": "Import purchase list",
  "Массовое добавление": "Bulk entry",
  "Импорт списка закупки": "Purchase list import",
  "Закрыть импорт": "Close import",
  "Вставьте заявки из сообщения или документа. Заголовки «Заявка» будут пропущены.": "Paste requests from a message or document. Request headings will be ignored.",
  "Текст списка закупки": "Purchase list text",
  "Строк: {count}": "Rows: {count}",
  "После объединения: {count}": "After merging: {count}",
  "Требуют проверки: {count}": "Need review: {count}",
  "Исходная строка": "Source row",
  "Товар для строки {line}": "Product for row {line}",
  "Количество для строки {line}": "Quantity for row {line}",
  "Единица для строки {line}": "Unit for row {line}",
  "Удалить строку {line}": "Delete row {line}",
  "Запомнить «{alias}»": "Remember “{alias}”",
  "Готово": "Ready",
  "Товар не найден": "Product not found",
  "Неоднозначно": "Ambiguous",
  "Нет количества": "Missing quantity",
  "Несовместимая единица": "Incompatible unit",
  "Назад": "Back",
  "Разобрать список": "Parse list",
  "Перенести в закупку": "Move to purchase",
  ...
  "Без дополнительных единиц": "No additional units",
  "Единицы": "Units",
  "Цены": "Prices",
  ...
  "Единица": "Unit",
  "Базовая единица": "Base unit",
  "Дополнительные единицы": "Additional units",
  "Цена закупки": "Purchase price",
  "Цена продажи": "Sale price",
  "Цена должна быть неотрицательным числом максимум с двумя знаками после точки.": "Price must be a non-negative number with no more than two decimal places.",
  "Коэффициент показывает количество базовой единицы в одной дополнительной.": "The factor is the amount of the base unit in one additional unit.",
  "Название единицы": "Unit name",
  "Например, пучок": "For example, bunch",
  "Коэффициент пересчёта": "Conversion factor",
  "Добавить единицу": "Add unit",
  "Удалить единицу {name}": "Delete unit {name}",
  "без названия": "unnamed",
  "Для каждой дополнительной единицы укажите название и положительный коэффициент.": "Enter a name and positive factor for every additional unit.",
  "Названия единиц не должны повторяться или совпадать с базовой единицей.": "Unit names must be unique and different from the base unit.",
  "шт, кг, л": "pcs, kg, l",
  ...
  "Импорт снимка": "Import snapshot",
  "Чтение…": "Reading…",
  "Предпросмотр импорта": "Import preview",
  "Проверка файла…": "Validating file…",
  "Новые": "New",
  "Совпадения": "Conflicts",
  "Ошибки": "Errors",
  "Обновить": "Update",
  ...
  "Ошибка": "Error",
  "Решение для {key}": "Resolution for {key}",
  "Импорт завершён: создано {created}, обновлено {updated}, пропущено {skipped}.": "Import complete: {created} created, {updated} updated, {skipped} skipped.",
  "Файл не содержит корректный JSON.": "The file does not contain valid JSON.",
  "Файл не является поддерживаемым пакетом Quanti.": "The file is not a supported Quanti package.",
  "Выбран пакет другого раздела: {section}.": "The package belongs to another section: {section}.",
  "Не удалось прочитать файл импорта.": "Unable to read the import file.",
  "Файл не является снимком отчёта Quanti.": "The file is not a Quanti report snapshot.",
  "Снимок отчёта повреждён.": "The report snapshot is damaged.",
  "Не удалось импортировать снимок отчёта.": "Unable to import the report snapshot.",
  "Не удалось экспортировать снимок отчёта.": "Unable to export the report snapshot.",
  "Импортированный снимок · {date}": "Imported snapshot · {date}",
  "Закрыть снимок": "Close snapshot",
  "Закрыть": "Close",
...
export function formatApiErrorForLocale(
  ...
  const messages = locale === "ru" ? {
    ...
    DATABASE_UNAVAILABLE: "Локальная база данных недоступна. Перезапустите Quanti или восстановите резервную копию в разделе диагностики.",
    ...
    DATABASE_UNAVAILABLE: "The local database is unavailable. Restart Quanti or restore a backup from Diagnostics.",
